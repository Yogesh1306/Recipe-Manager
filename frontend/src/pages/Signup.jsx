            ...
            <div className="w-full flex-1 mt-4">
              ...
              <div className="mx-auto max-w-xs ">
                ...
                <div>
                  <input
                    id="email"
                    className="border p-3 mt-2 dark:bg-indigo-200 dark:text-gray-900  dark:border-gray-700 shadow-md placeholder:text-base focus:scale-105 ease-in-out duration-300 border-gray-300 rounded-lg w-full"
                    type="email"
                    placeholder="Email"
                    required
                    value={email}
                ...
                <div className="relative">
                  <input
                    id="password"
                    className="border p-3 mt-2 shadow-md dark:bg-indigo-200 dark:text-gray-900  dark:border-gray-700 placeholder:text-base focus:scale-105 ease-in-out duration-300 border-gray-300 rounded-lg w-full"
